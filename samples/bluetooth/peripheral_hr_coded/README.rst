...
The advertiser is configured to use the S=8 coding scheme, but this can be changed or removed depending on the applications needs through the advertising options.
